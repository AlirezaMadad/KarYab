...
public class MailAddressListActivity extends Fragment {
    public View onCreateView(LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_mail_address_list, null);
        return view;
    }
    @Override
    public void onViewCreated(View view, Bundle savedInstanceState) {
        Adad.initialize(getActivity());
        final FloatingActionButton fab = (FloatingActionButton) view.findViewById(R.id.fabGoToTemp);
        //final FloatingActionButton fabGoToCellPhone = (FloatingActionButton) view.findViewById(R.id.fabGoToMailAddress);
        ...
        List<MAILADRESS> addresses = HttpMadad.getObjects(MAILADRESS[].class, UrlStatic.UrlOfGetHumanMailAddressesApi + "?humanid=" + humanID);
        ScrollView scrollView = (ScrollView) view.findViewById(R.id.mailAddressListScrollView);
        LinearLayout tempLayout = new LinearLayout(getActivity());
        tempLayout.setOrientation(LinearLayout.VERTICAL);
        //for(IDS id : ids){
        for (final MAILADRESS address : addresses) {
            //if(id.getData() != 0){
            ...
            //tempRadioButton.setText(String.valueOf(address.MAILADRESS1));
            TextView tempNameTextView = new TextView(getActivity());
            tempNameTextView.setText("ایمیل: "+address.MAILADRESS1);
            ...
            editButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    //Intent myIntent = new Intent(getActivity(), MailAdressModifyActivity.class);
                    //myIntent.putExtra("ID", address.ID);
                    //getActivity().startActivity(myIntent);
                    Intent intent = new Intent(getActivity(),MailAdressModifyActivity.class);
            ...
            deleteButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    boolean finished = HttpMadad.postObjectAndGetBool(address, UrlStatic.UrlOfDeleteHumanMailAdressApi);
                    Toast.makeText(getActivity(), "حذف شد!", Toast.LENGTH_LONG).show();
                    getFragmentManager().beginTransaction().detach(MailAddressListActivity.this).attach(MailAddressListActivity.this).commit();
...
//            }
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //progressBar.setVisibility(View.VISIBLE);
                //Intent intent = new Intent(getActivity(), MaillAdressActivity.class);
                //startActivity(intent);
                Intent intent = new Intent(getActivity(),MaillAdressActivity.class);
                startActivityForResult(intent, 1);
                //finish();
